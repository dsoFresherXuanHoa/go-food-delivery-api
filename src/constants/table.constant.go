...
var (
	...
	CannotReadAllTable                   = "Cannot read all Table right now: Check your information or permission again! If you think nothing went wrong, try again later!"
	...
	CannotReadAllTableSuccess             = "Read all Table and status success: congrats!"
