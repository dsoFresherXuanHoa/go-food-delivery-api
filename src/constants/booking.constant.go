...
var (
	...
	CannotGetAllBooking              = "Cannot get all booking right now: Check your information or permission again! If you think nothing went wrong, try again later!"
	...
	GetAllBookingSuccess              = "Get all booking success: congrats!"
